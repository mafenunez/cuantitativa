...
.content-block-gray[
## .gray[Sesión 13:] 
## .curso[Escritura en documentos dinámicos y reproducibilidad]]
]
]
...
.pull-left-wide[
![:scale 95%](img/reproducibility_science.png)
]
.pull-right-narrow[
<br>
<br>
...
![](img/nature-reproducibility-crisis.jpeg)
...
## .yellow[B. Texto plano y Markdown]
...
.right-column[
.right[
![:scale 100%](img/markdownpreview.png)
]]
...
- Menú en ventana de RStudio *Insert* > R ![:scale 20%](img/insertchunk.png)
...
## .yellow[Resumen RMarkdown / Quarto]
...
## .yellow[D. Protocolos reproducibles]
]
...
.center[
.medium[
![:scale 65%](img/ipo.png)
###[https://lisa-coes.com/ipo-repro/](https://lisa-coes.github.io/ipo/)
