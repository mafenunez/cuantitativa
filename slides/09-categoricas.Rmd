...
.large[
[Moore cap 9: <br> INFERENCIA PARA TABLAS
...
# Hoy Unidad 3: Asociación con variables categóricas
...
En la lista CASEN al final hay una item de "no ha sido discriminado", quienes responden si son quienes no se han sentido discriminados, por lo tanto mejor cambiar las etiquetas para evitar confusiones

```{r}
casen2022_chi$r9t <- sjlabelled::set_labels(casen2022_chi$r9t,
...
---
Y cambiamos el nombre de la variable (r9t) por uno más sustantivo:

```{r}
casen2022_chi <- rename(casen2022_chi,"discrim"=r9t)
frq(casen2022_chi$discrim)
```

---
Ahora con la variable educación:
...
Esta tabla estaría expresando nuestra hipótesis (alternativa): existen diferencias al cruzar estas variables, y por lo tanto hay asociación entre educación y percepción de discriminación
