...
knitr::include_graphics("../files/yaml.png", error = FALSE)
```
...
::: {details}
## Título de la Tabla
Aquí puedes dar una breve introducción o explicación de la tabla.

```{r}
# Código para generar la tabla
library(dplyr)
mtcars %>% head()  # Ejemplo con datos de mtcars
```
:::
