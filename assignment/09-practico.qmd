...
El objetivo de esta guía práctica es explicar el formato del informe de los trabajos del curso. Ya que la elaboración de los informes incluye analisis en R, la idea es poder aprovechar los recursos existentes para poder realizar escritura y análisis en un mismo documento. La base de esto son los prácticos sobre [Reportes Dinámicos 1](/assignment/01-practico.html) y [Reportes Dinámicos 2](/assignment/01-practico.html), donde se describieron las estructura de carpetas y archivos, así como también el lenfuage RMarkdown, que permite vincular análisis en R con escritura en Markdown.

Para facilitar el desarrollo de los trabajos en este entorno ponemos a disposición una carpeta que se puede bajar [aquí](https://github.com/cursos-metodos-facso/plantilla_informe/archive/refs/heads/main.zip). Esta carpeta está basada en el protocolo **IPO**, mencionado en el práctico [Reportes Dinámicos 1](/assignment/01-practico.html), con la siguente estructura de archivos y carpetas:
