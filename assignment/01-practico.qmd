...
El objetivo de esta guía práctica es introducirnos en la inferencia estadística, revisando los conceptos y aplicaciones de la curva normal y las probabilidades bajo esta con puntajes Z, y el cálculo de intervalos de confianza.
...
Cargaremos algunas librerías que serán necesarias en esta guía práctica:
...
```{r}
boxplot(vector, main = "Diagrama de Caja del Vector aleatorio", ylab = "Valor", col = "cyan4")
```
...
En el caso del vector, que creamos con datos aleatorios, la media $\bar{x} = 5,18$ nos muestra que el promedio de los datos se encuentra en torno a 5,2. 
...
Para pensar en la idea de probabilidad realicemos la tarea propuesta en la Clase 2.
