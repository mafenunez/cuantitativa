...
Tenemos que la correlación entre la variable de `mesfuerzo` y `mtalento` es de 0.69. 
...
Obtengamos el coeficiente de correlación $r$ de Pearson entre el nivel educacional alcanzado y el estatus social subjetivo de las personas en Chile en 2016. Para esto usaremos solamente observaciones completas (_listwise_).
...
Aqui completar MARTIN

- no captura relaciones no lineales bien
- sensible a valores extremos
- una correlacion puede reflejar distribuciones de asociacion distintas (Anscombe)
