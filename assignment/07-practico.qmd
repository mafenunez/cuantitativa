...
_Tufte & Graves-Morris [-@tufte1983visual], The Visual Display of Quantitative Information, p. 51_
...
El primer paso (recomendado) para generar gráficos en R es crear un objeto o base de datos ya procesada que contenga las variables que nos interesa listas para gráficas. Luego, ir aplicando capa por capa los diferentes elementos de mapping, geometría, escalas, estadísticas y elementos estéticos útiles. 
...
Evaluemos cómo se asocia la preferencias por la redistribución de los países con su nivel de desigualdad económica.
