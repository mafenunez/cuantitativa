...
## Seis pasos para la inferencia estadística

En inferencia, las pruebas de hipótesis nos ayudan a determinar si el resultado que obtenemos en nuestra muestra es un efecto real/extensible a la población o un error de muestreo. Aquí recomendamos una lista de seis pasos lógicos para enfrentarnos a la inferencia estadística: 
...
<table>
  ...
  <tr>
    ...
    <td class="cell-left">Calcula el valor estimado de la prueba</td>
  </tr>
  <tr>
    <td class="cell-left">5</td>
    <td class="cell-left">Contrasta el valor estimado con el valor crítico y toma la desición de rechazo</td>
  </tr>
  <tr>
    <td class="cell-left">6</td>
    <td class="cell-left">Interpreta y comunica los resultados</td>
  </tr>
</table>
...
3. Especifica el valor crítico de la prueba:
...
5. Contrasta el valor estimado con el crítico y toma la desición de rechazo: 
...
3. Especifica el valor crítico.

```{r, echo=TRUE, warning=FALSE, message=FALSE, collapse=FALSE}

df <- n_0 + n_1 - 2 # definimos grados de libertad

t_critico <- qt(1 - 0.05, df)
...
5. Contrasta el valor estimado con el crítico y toma desición de rechazo.
...
6. Interpreta y comunica los resultados. 
