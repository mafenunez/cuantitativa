...
El objetivo de esta guía práctica es recordar algunos procedimientos básicos de la preparación de datos con R, y enfatizar en la recodificación de variables para la transformación de índices.

En detalle, aprenderemos:

1. Procesar una base de datos: **CASEN 2022**

2. Recodifcar y transformar indicadores según condiciones: `case_when()`, `if_else()`

3. Generar el **índice de pobreza multidimensional (IPM)**
