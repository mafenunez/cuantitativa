...
La forma de combinar ambas bases se presenta en la página de prácticos del curso, link directo [acá](/assignment/11-practico.html).
:::
...
El formato de entrega del trabajo será en html vía Rmarkdown, dado facilita la integración y reproducibilidad de los análisis en R. La plantilla para poder realizar el trabajo se explica en el [Práctico 9](https://correlacional.netlify.app/assignment/09-practico).
...
**Cómo hacerlo**: Tal como se ejemplificó en la [sesión de Inferencia 3](/content/07-content.html) (lámina 25), se sugiere generar un subset de CASEN con los datos a utilizar, grabar el subset como una nueva base con formato Rdata, y esos datos incluirlos en la carpeta input/data. El código que genera este subset debe quedar respaldado en la carpeta de procesamiento (proc), con un nombre del tipo subset.R.
...
Y luego, en el documento (ej: [plantilla Quarto del trabajo](/assignment/09-practico.html)), comenzar con:
...
![](docs/fotos/20231121_103623.jpg)

![](docs/fotos/20231121_103641.jpg)

![](docs/fotos/20231121_103644.jpg)

![](docs/fotos/20231121_103709.jpg)

![](docs/fotos/20231121_111645.jpg)

![](docs/fotos/20231121_111924.jpg)

![](docs/fotos/20231121_111945.jpg)
